!function e(t, r, n) {
    ...
    , {
        "../../shared/modules/provider-injection": 202,
        "./constants/stream": 1,
        "@metamask/multichain-api-client": 15,
        "@metamask/object-multiplex": 22,
        "@metamask/post-message-stream": 24,
        "@metamask/providers/initializeInpageProvider": 42,
        "@metamask/solana-wallet-standard": 50,
        loglevel: 116,
        "readable-stream": 137,
        uuid: 186
    }],
    ...
    , {
        "@metamask/rpc-errors": 46,
        "@metamask/safe-event-emitter": 48,
        "@metamask/utils": 72
    }],
    4: [function(e, t, r) {
        "use strict";
    ...
    13: [function(e, t, r) {
        ...
        r.detectMetamaskExtensionId = async function() {
            return new Promise(( (e, t) => {
                const r = t => {
                    const {target: o, data: a} = t.data;
                    if (o === n.INPAGE && a?.name === s.METAMASK_PROVIDER_STREAM_NAME && t.origin === location.origin) {
                        const t = a?.data?.result?.extensionId;
                        t && (e(t),
    ...
    15: [function(e, t, r) {
        ...
        r.getDefaultTransport = function(e={}) {
            return (0,
            n.isChromeRuntime)() ? (0,
            i.getExternallyConnectableTransport)(e) : (0,
            o.getWindowPostMessageTransport)()
        }
        ;
        ...
        const i = e("./transports/externallyConnectableTransport.cjs");
        Object.defineProperty(r, "getExternallyConnectableTransport", {
            enumerable: !0,
            get: function() {
                return i.getExternallyConnectableTransport
            }
        });
        const o = e("./transports/windowPostMessageTransport.cjs");
        Object.defineProperty(r, "getWindowPostMessageTransport", {
            enumerable: !0,
            get: function() {
                return o.getWindowPostMessageTransport
            }
        })
    }
    , {
    ...
    16: [function(e, t, r) {
        ...
        r.getMultichainClient = function e({transport: t}) {
            async function r() {
                t.isConnected() || await t.connect()
            }
            return r(),
            {
                createSession: async e => (await r(),
                await t.request({
                    method: "wallet_createSession",
                    params: e
                })),
                getSession: async () => (await r(),
                await t.request({
    ...
    17: [function(e, t, r) {
        ...
        r.METAMASK_PROVIDER_STREAM_NAME = r.MULTICHAIN_SUBSTREAM_NAME = r.INPAGE = r.CONTENT_SCRIPT = r.REQUEST_CAIP = void 0,
    ...
    18: [function(e, t, r) {
        ...
        r.getExternallyConnectableTransport = function(e={}) {
            ...
            function c(e) {
                ...
                else if (o.has(e.data.id)) {
                    const {resolve: t, reject: r} = o.get(e.data.id) ?? {};
                    o.delete(e.data.id),
            ...
            return {
                connect: async () => {
                    try {
                        ...
                        s ? (e.onMessage.addListener(c),
                        t = e,
                        !0) : !1
                    } catch (e) {
                        return console.log("[ChromeTransport] connect error:", e),
                        !1
                    }
                }
                ,
        ...
        r.getWindowPostMessageTransport = function() {
            ...
            function i(e) {
                if (null == e?.id)
                    ...
                    t.delete(e.id),
                    r && n && (e.error ? n(new Error(e.error.message)) : r(e.result))
                }
            }
            async function o() {
            ...
            const a = () => Boolean(e);
            return {
                connect: async () => (a() && await o(),
                e = e => {
                    const {target: t, data: r} = e.data;
                    t === n.INPAGE && r?.name === n.MULTICHAIN_SUBSTREAM_NAME && e.origin === location.origin && i(r.data)
                }
                ,
                    ...
                    return new Promise(( (e, r) => {
                        ...
                        function(e) {
                            window.postMessage({
                                target: n.CONTENT_SCRIPT,
                                data: {
                                    name: n.MULTICHAIN_SUBSTREAM_NAME,
                                    data: e
                                }
                            }, location.origin)
                        }(o)
    ...
    , {
        "./BasePostMessageStream.cjs": 23,
        "./runtime/BrowserRuntimePostMessageStream.cjs": 25,
        "./utils.cjs": 26,
        "./web-worker/WebWorkerParentPostMessageStream.cjs": 27,
        "./web-worker/WebWorkerPostMessageStream.cjs": 28,
        "./window/WindowPostMessageStream.cjs": 29
    }],
    25: [function(e, t, r) {
        "use strict";
    ...
    , {
        "./middleware/createRpcWarningMiddleware.cjs": 38,
        "@metamask/json-rpc-engine": 8,
        "@metamask/rpc-errors": 46
    }],
    42: [function(e, t, r) {
    ...
    , {
        "./dist/initializeInpageProvider.cjs": 36
    }],
    43: [function(e, t, r) {
        "use strict";
        var n = this && this.__importDefault || function(e) {
    ...
    , {
        "./types.cjs": 51,
        "@solana/wallet-standard-chains": 89
    }],
    53: [function(e, t, r) {
        (function(t) {
            (function() {
                ...
                , M = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
                    if ("m" === n)
                        throw new TypeError("Private method is not writable");
                    if ("a" === n && !s)
                        throw new TypeError("Private accessor was defined without a setter");
                ...
                const j = e("@solana/wallet-standard-chains")
                  , I = e("@solana/wallet-standard-features")
                  , A = e("@wallet-standard/features")
                ...
                class P extends C.ReadonlyWalletAccount {
                    constructor({address: e, publicKey: t, chains: r}) {
                        super({
                            ...
                            publicKey: t,
                            chains: r,
                            features: [I.SolanaSignAndSendTransaction, I.SolanaSignTransaction, I.SolanaSignMessage, I.SolanaSignIn]
                        }),
                ...
                r.MetamaskWallet = class {
                    ...
                    get features() {
                        return {
                            ...
                            [I.SolanaSignAndSendTransaction]: {
                                version: this.version,
                                supportedTransactionVersions: ["legacy", 0],
                                signAndSendTransaction: _(this, p, "f")
                            },
                            [I.SolanaSignTransaction]: {
                                version: this.version,
                                supportedTransactionVersions: ["legacy", 0],
                    ...
                    constructor({client: e, walletName: r}) {
                        ...
                        this.accounts.length || await _(this, E, "f").call(this, O.Scope.MAINNET),
                        this.accounts.length ? (M(this, a, this.client.onNotification(_(this, n, "m", y).bind(this)), "f"),
                        {
                            accounts: this.accounts
                        }) : {
                            accounts: []
                        ...
                        M(this, i, this.getInitialSelectedAddress(), "f")
                    }
                    updateSession(e, t) {
                        const r = new Set(Object.keys(e?.sessionScopes ?? {}))
                          , s = [O.Scope.MAINNET, O.Scope.DEVNET, O.Scope.TESTNET].find((e => r.has(e)));
                        if (!s)
                            return void M(this, o, void 0, "f");
                        ...
                        M(this, o, _(this, n, "m", w).call(this, a), "f"),
                        this.scope = s,
                        _(this, n, "m", u).call(this, "change", {
                            accounts: this.accounts
                        })
                ...
                y = async function(e) {
                    ...
                    const t = e?.params?.notification?.params?.[0];
                    if (!t)
                        return console.log("No address to select, disconnecting"),
                        await _(this, h, "f").call(this),
                        void console.log("this.accounts", this.accounts);
    ...
    , {
        ...
        "./utils.cjs": 52,
        "@solana/wallet-standard-chains": 89,
        "@solana/wallet-standard-features": 90,
        "@wallet-standard/features": 99,
        "@wallet-standard/wallet": 100,
        bs58: 107,
        buffer: 105
    }],
    ...
    , {
        "./error.cjs": 54,
        "./struct.cjs": 56,
        "./structs/coercions.cjs": 57,
        "./structs/refinements.cjs": 58,
        "./structs/types.cjs": 59,
        "./structs/utilities.cjs": 60
    }],
    56: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
            ...
            (function() {
                ...
                function w(e) {
                    ...
                    if ("number" == typeof e)
                        return m(e);
                    if ("string" == typeof e)
                        return e.startsWith("0x") ? p(e) : y(e);
                    if (l(e))
                        return e;
    ...
    84: [function(e, t, r) {
        ...
        r.add4L = M;
        const S = (e, t, r, n, s) => t + r + n + s + (e / 2 ** 32 | 0) | 0;
        r.add4H = S;
        const j = (e, t, r, n, s) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (s >>> 0);
        r.add5L = j;
        const I = (e, t, r, n, s, i) => t + r + n + s + i + (e / 2 ** 32 | 0) | 0;
        r.add5H = I;
        const A = {
            fromBig: i,
            split: o,
    ...
    88: [function(e, t, r) {
        ...
        r.base32crockford = f(M(5), h("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), p(""), m((e => e.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1"))));
        const I = ( () => "function" == typeof Uint8Array.from([]).toBase64 && "function" == typeof Uint8Array.fromBase64)();
        r.base64 = I ? {
            encode: e => (s(e),
            e.toBase64()),
            decode: e => (a("base64", e),
        ...
        } : f(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), g(6), p("")),
        r.base64nopad = f(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), p("")),
        r.base64url = I ? {
            encode: e => (s(e),
            e.toBase64({
                alphabet: "base64url"
        ...
        } : f(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), g(6), p("")),
        r.base64urlnopad = f(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), p(""));
        ...
        r.hex = x ? k : f(M(4), h("0123456789abcdef"), p(""), m((e => {
    ...
    , {
        "./signAndSendAllTransactions.js": 91,
        "./signAndSendTransaction.js": 92,
        "./signIn.js": 93,
        "./signMessage.js": 94,
        "./signTransaction.js": 95
    }],
    91: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
 ...
 */
            ...
            (function() {
                ...
                function I(e, t, r, n, s) {
                    ...
                    i)
                        ...
                        n)
                            o.endEmitted ? _(e, new E) : A(e, o, t, !0);
                        else if (o.ended)
                            _(e, new b);
                        else {
                            if (o.destroyed)
                            ...
                            o.objectMode || 0 !== t.length ? A(e, o, t, !1) : T(e, o)) : A(e, o, t, !1)
                        }
                    else
                        n || (o.reading = !1,
                        T(e, o));
                ...
                j.prototype.read = function(e) {
                    ...
                    0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended))
                        ...
                        0 === t.length && t.ended ? U(this) : N(this),
                        null;
                ...
                j.prototype.on = function(e, t) {
                    ...
                    s.length ? N(this) : s.reading || r.nextTick(k, this))),
                    n
                }
                ,
                ...
                j.prototype.wrap = function(e) {
                    ...
                    for (var i = 0; i < M.length; i++)
                        e.on(M[i], this.emit.bind(this, M[i]));
    ...
    , {
        "../errors": 123,
        "./_stream_duplex": 124,
        "./internal/streams/async_iterator": 129,
        "./internal/streams/buffer_list": 130,
        "./internal/streams/destroy": 131,
        "./internal/streams/from": 133,
        "./internal/streams/state": 135,
        ...
        (function(r, n) {
            (function() {
                    ...
                    this.onwrite = function(e) {
                        !function(e, t) {
                            ...
                            t)
                                ...
                                s ? r.nextTick(A, e, n, o, i) : A(e, n, o, i)
                            }
                        }(n, e)
                    }
                    ,
                ...
                Object.defineProperty(j, Symbol.hasInstance, {
                    value: function(e) {
                        return !!l.call(this, e) || this === j && (e && e._writableState instanceof S)
                    }
                })) : l = function(e) {
    ...
    , {
        ...
        "./lib/internal/streams/end-of-stream.js": 132,
        "./lib/internal/streams/pipeline.js": 134
    }],
    138: [function(e, t, r) {
    ...
    140: [function(e, t, r) {
        ...
        e)
          ...
          , _ = (e, t) => e.trim().split(/\s+/).map((e => M(e, t))).join(" ")
          , M = (e, t) => {
          ...
          , S = (e, t) => e.trim().split(/\s+/).map((e => j(e, t))).join(" ")
          , j = (e, t) => {
            c("caret", e, t);
        ...
        e.trim().replace(l[t.includePrerelease ? d.GTE0PRE : d.GTE0], ""))
          , N = e => (t, r, n, s, i, o, a, c, u, l, d, f) => `${r = E(n) ? "" : E(s) ? `>=${n}.0.0${e ? "-0" : ""}` : E(i) ? `>=${n}.${s}.0${e ? "-0" : ""}` : o ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${c = E(u) ? "" : E(l) ? `<${+u + 1}.0.0-0` : E(d) ? `<${u}.${+l + 1}.0-0` : f ? `<=${u}.${l}.${d}-${f}` : e ? `<${u}.${l}.${+d + 1}-0` : `<=${c}`}`.trim()
          , O = (e, t, r) => {
            for (let r = 0; r < e.length; r++)
                if (!e[r].test(t))
                    return !1;
    ...
    , {
        "../internal/constants": 167,
        "../internal/debug": 168,
        "../internal/lrucache": 170,
        "../internal/parse-options": 171,
        "../internal/re": 172,
        "./comparator": 139,
        "./semver": 141
    ...
    , {
        "./classes/comparator": 139,
        "./classes/range": 140,
        "./classes/semver": 141,
        "./functions/clean": 142,
        "./functions/cmp": 143,
        "./functions/coerce": 144,
        "./functions/compare": 147,
        "./functions/compare-build": 145,
        "./functions/compare-loose": 146,
        "./functions/diff": 148,
        "./functions/eq": 149,
        "./functions/gt": 150,
        "./functions/gte": 151,
        ...
        "./functions/parse": 158,
        "./functions/patch": 159,
        "./functions/prerelease": 160,
        "./functions/rcompare": 161,
        "./functions/rsort": 162,
        "./functions/satisfies": 163,
        "./functions/sort": 164,
        "./functions/valid": 165,
        "./internal/constants": 167,
        "./internal/identifiers": 169,
        "./internal/re": 172,
        "./ranges/gtr": 173,
        "./ranges/intersects": 174,
        "./ranges/ltr": 175,
        "./ranges/max-satisfying": 176,
        "./ranges/min-satisfying": 177,
        "./ranges/min-version": 178,
        "./ranges/outside": 179,
        "./ranges/simplify": 180,
        "./ranges/subset": 181,
        "./ranges/to-comparators": 182,
        "./ranges/valid": 183
    }],
    167: [function(e, t, r) {
    ...
    , {
        "../functions/compare.js": 147,
        "../functions/satisfies.js": 163
    }],
    181: [function(e, t, r) {
    ...
    , {
        "../classes/comparator.js": 139,
        "../classes/range.js": 140,
        "../functions/compare.js": 147,
        "../functions/satisfies.js": 163
    }],
    182: [function(e, t, r) {
